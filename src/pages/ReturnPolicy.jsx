  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="سياسة الاسترجاع والاستبدال | عُشبة ستور"
        />
        <meta
          property="og:description"
          content="تعرف على سياسة الاسترجاع والاستبدال في متجر عُشبة."
        />
        <meta
          property="og:url"
          content="https://oshbahstore.com/return-policy"
        />
        <meta property="og:image" content="https://oshbahstore.com/logo.png" />
        <title>سياسة الاسترجاع والاستبدال | عُشبة ستور</title>

        <meta
          name="description"
          content="تعرف على سياسة الاسترجاع والاستبدال في متجر عُشبة، وشروط إعادة أو استبدال المنتجات."
        />

        <link rel="canonical" href="https://oshbahstore.com/return-policy" />
      </Helmet>
        ...
        <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-lg md:p-12">
          ...
          <div className="space-y-10 text-gray-700 leading-8">
            <div>
              ...
              <p>
                في <strong>عُشبة ستور</strong> نسعى لتقديم منتجات عالية الجودة
                وضمان رضا عملائنا، لذلك يمكن طلب استرجاع المنتج خلال
            ...
            <div>
              ...
              <p className="mt-4">
                في هذه الحالات يتحمل المتجر جميع تكاليف الشحن.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc space-y-2 pr-6">
                ...
                <li>الأعشاب والمكملات الغذائية بعد إزالة التغليف.</li>
            ...
            <div>
              ...
              <ul className="list-disc space-y-2 pr-6">
                ...
                <li>
                  إذا كان الخطأ من المتجر أو المنتج تالفًا، يتحمل المتجر جميع
                  تكاليف الشحن.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p>
                يمكن إلغاء الطلب مجانًا قبل شحنه، أما بعد الشحن فتطبق سياسة
            ...
            <div>
              ...
              <ul className="mt-4 list-disc space-y-2 pr-6">
                ...
                <li>صفحة اتصل بنا داخل الموقع.</li>
              </ul>
            </div>
          </div>
        </div>
